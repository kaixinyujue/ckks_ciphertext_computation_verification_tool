...
#ifndef RINGSNARK_SEAL_RING_CKKS_CONST_HPP
#define RINGSNARK_SEAL_RING_CKKS_CONST_HPP
...
//        using PublicKey = nullptr_t;  // No keying material needed to evaluate affine
        using PublicKey = vector<::seal::PublicKey>;
...
//            PublicKey pk = nullptr;
        ...
        // for efficiency
        static std::vector<EncodingElem> encode(const PublicKey &pk,
...
#include "seal_ring_ckks_const.tcc"

#endif //RINGSNARK_SEAL_RING_CKKS_CONST_H
